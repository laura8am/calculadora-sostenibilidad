...
Dataset: 42 productos validados
"""
...
def main():
    ...
    # ========================================================================
        ...
        st.markdown("---")
        st.subheader("📋 Los Productos Ultra Robustos")
        
        # Categorizar (actualizado para incluir nuevos productos)
        categorias = {
            'Frutas': ['Aguacate', 'Mango', 'Naranja', 'Plátano', 'Limón', 'Manzana', 'Sandía', 'Guayaba', 'Papaya', 'Piña', 'Melón', 'Uva'],
        ...
        for categoria in ['Frutas', 'Vegetales', 'Leguminosas', 'Otros']:
        ...
        Siguiendo una dieta basada en los **{len(productos_robustos)} productos robustos** vs. productos menos sostenibles:
    ...
    # ========================================================================
        ...
        **Validación Científica:**
        ...
        - **Carbon Footprint:** López-Olmedo et al. (2022), SU-EATABLE LIFE Database
        ...
        **Dataset:** 42 productos validados con datos específicos de México
        ...
        **Justificación del ajuste:**
        ...
        Basado en los **productos ultra robustos** (presentes en Top 10 de ambos escenarios):
        
        **Frutas (consumo diario):**
        - Sandía, Guayaba, Papaya, Aguacate, Mango, Naranja
